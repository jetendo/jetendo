...
<cffunction name="getFormField" localmode="modern" access="public">
	...
	v='<input type="text" name="#arguments.prefixString##arguments.row["feature_field_id"]#" id="#arguments.prefixString##arguments.row["feature_field_id"]#" ';
...
<cffunction name="getTypeForm" localmode="modern" access="public">
	...
	<input type="radio" name="feature_field_type_id" value="0" onClick="setType(0);" <cfif value EQ "0">checked="checked"</cfif>/>
	Text<br />
	</cfsavecontent>
	<cfreturn output>
</cffunction> 
