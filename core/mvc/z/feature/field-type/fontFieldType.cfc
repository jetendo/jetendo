...
<cffunction name="loadFontData" localmode="modern" access="public">
	<cfscript>
...
<cffunction name="getFormField" localmode="modern" access="public">
	...
	savecontent variable="out"{
		...
		selectStruct.query = request.zos.qWebFont;
		selectStruct.hideSelect=false;
		// selectStruct.inlineStyle="max-width:200px;"; 
		selectStruct.queryLabelField = "webfont_name";
		selectStruct.queryValueField = "webfont_id";
...
<cffunction name="getListValue" localmode="modern" access="public">
	...
	loadFontData();
	webfont=application.zcore.functions.zGetWebfontById(arguments.value);
	if(structcount(webfont)){
		return webfont.webfont_name;
	}else{
		return "";
	}
	</cfscript>
...
<cffunction name="getTypeForm" localmode="modern" access="public">
	...
	<input type="radio" name="feature_field_type_id" value="28" onClick="setType(28);" <cfif value EQ "28">checked="checked"</cfif>/>
	Font<br />
	</cfsavecontent>
	<cfreturn output>
</cffunction> 
