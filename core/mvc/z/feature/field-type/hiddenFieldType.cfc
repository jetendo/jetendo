...
<cffunction name="getFormField" localmode="modern" access="public">
	...
	<cfargument name="dataStruct" type="struct" required="yes">  
	<cfscript>
	return { label: false, hidden: true, value:'<input type="hidden" name="#arguments.prefixString##arguments.row["feature_field_id"]#" id="#arguments.prefixString##arguments.row["feature_field_id"]#" value="#htmleditformat(application.zcore.functions.zso(arguments.dataStruct, '#arguments.prefixString##arguments.row["feature_field_id"]#'))#" />'};
	</cfscript>
</cffunction>
...
<cffunction name="getTypeForm" localmode="modern" access="public">
	...
	<input type="radio" name="feature_field_type_id" value="12" onClick="setType(12);" <cfif value EQ 12>checked="checked"</cfif>/>
	Hidden Field<br />
	<div id="typeFields12" style="display:none;padding-left:30px;"></div>	
	</cfsavecontent>
	<cfreturn output>
</cffunction> 
