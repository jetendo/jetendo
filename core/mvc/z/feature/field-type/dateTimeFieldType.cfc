...
<cffunction name="getFormField" localmode="modern" access="public">
	...
	');
	return { label: true, hidden: false, value:'<input type="text" name="#arguments.prefixString&arguments.row["feature_field_id"]#_date" id="#arguments.prefixString&arguments.row["feature_field_id"]#_date" value="#curDate#" size="9" style="width:auto; min-width:auto;" size="9" />
