...
<cffunction name="index" localmode="modern" access="remote" roles="member">
	...
	<cfif application.zcore.user.checkGroupAccess("member") or form.method EQ "userIndex">
		...
		function loadExport(){
			...
			window.open("<cfif form.method EQ "index">/z/inquiries/admin/export/index<cfelse>/z/inquiries/admin/manage-inquiries/userExport</cfif>?search_office_id=#form.search_office_id#&search_keyword=#urlencodedformat(form.inquiries_search)#&search_email=#urlencodedformat(form.search_email)#&search_phone=#urlencodedformat(form.search_phone)#&uid=#form.uid#&inquiries_status_id=#form.inquiries_status_id#&inquiries_type_id=#urlencodedformat(application.zcore.functions.zso(form, 'inquiries_type_id'))#&inquiries_name=#urlencodedformat(application.zcore.functions.zso(form, 'inquiries_name'))#&inquiries_start_date=#urlencodedformat(dateformat(form.inquiries_start_date,'yyyy-mm-dd'))#&inquiries_end_date=#urlencodedformat(dateformat(form.inquiries_end_date,'yyyy-mm-dd'))#&format="+format+"&exporttype="+exporttype+"&whichfields="+whichfields);
		}
		/* ]]> */
		</script>  
