...
<cffunction name="getFormField" localmode="modern" access="public">
	...
	return { label: true, hidden: false, value:'<input type="text" aria-label="#arguments.row["#variables.type#_option_name"]# - Enter Date" #required# name="#arguments.prefixString&arguments.row["#variables.type#_option_id"]#_date" id="#arguments.prefixString&arguments.row["#variables.type#_option_id"]#_date" value="#curDate#" size="9" style="width:auto; min-width:auto;" size="9" />
	 Time: <input type="text" aria-label="#arguments.row["#variables.type#_option_name"]# - Enter Time" name="#arguments.prefixString&arguments.row["#variables.type#_option_id"]#_time" style="width:auto; min-width:auto;" id="#arguments.prefixString&arguments.row["#variables.type#_option_id"]#_time" value="#htmleditformat(curTime)#" size="10" /> (Time is optional)'};
	</cfscript>
</cffunction>
