...
<cffunction name="getFormField" localmode="modern" access="public">
	...
	v='<input type="text" #required# name="#arguments.prefixString##arguments.row["#variables.type#_option_id"]#" id="#arguments.prefixString##arguments.row["#variables.type#_option_id"]#" ';
