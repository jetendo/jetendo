...
<cffunction name="parseRawData" localmode="modern" output="yes" returntype="any">
	...
	local.listing_subdivision=ts['Subdivision'];
	...
	local.arrRoom=listToArray('room_br2_room,room_br3_room,room_br4_room,room_dn_room,room_fr_room,room_ki_room,room_lv_room,room_mb_room,room_ot_room,room_pr_room,room_pt_room,room_b1_room,room_ba_room,room_br1_room,room_br2_room,room_br3_room,room_br4_room,room_dn_room,room_fr_room,room_ki_room,room_lv_room,room_or1_room', ',');
