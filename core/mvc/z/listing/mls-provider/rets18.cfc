...
<cfoutput>	<cfscript>
	...
	variables.resourceStruct["property"].id="mlsnum";
	variables.resourceStruct["office"]=structnew();
	variables.resourceStruct["office"].resource="office";
	variables.resourceStruct["office"].id="uid";
	variables.resourceStruct["agent"]=structnew();
	variables.resourceStruct["agent"].resource="agent";
	variables.resourceStruct["agent"].id="uid";
	variables.resourceStruct["media"]=structnew();
	variables.resourceStruct["media"].id="tableuid";
	variables.resourceStruct["media"].resource="media";
	</cfscript> 
