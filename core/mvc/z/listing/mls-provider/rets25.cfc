...
<cfoutput>
	...
	this.arrColumns=listtoarray("ListingKeyNumeric,BathroomsFull,BathroomsHalf,BathroomsTotalInteger,BedroomsTotal,BuildingAreaSource,BuildingAreaTotal,BuyerAgencyCompensation,BuyerAgentAOR,BuyerAgentFullName,BuyerAgentMlsId,BuyerOfficeMlsId,BuyerOfficeName,CloseDate,ClosePrice,CoBuyerAgentFullName,CoBuyerAgentMlsId,CoBuyerOfficeMlsId,CoBuyerOfficeName,CoListAgentDirectPhone,CoListAgentFullName,CoListAgentMlsId,CoListOfficeMlsId,CoListOfficeName,Cooling,CountyOrParish,CumulativeDaysOnMarket,DaysOnMarket,Directions,Heating,InternetAddressDisplayYN,InternetConsumerCommentYN,InternetEntireListingDisplayYN,Latitude,ListAgentAOR,ListAgentDirectPhone,ListAgentEmail,ListAgentFullName,ListAgentKeyNumeric,ListAgentMlsId,ListAOR,ListingAgreement,ListingContractDate,ListingId,ListOfficeKeyNumeric,ListOfficeMlsId,ListOfficeName,ListOfficePhone,ListPrice,LivingArea,Longitude,MlsStatus,ModificationTimestamp,OffMarketDate,OriginalEntryTimestamp,OriginalListPrice,OriginatingSystemName,ParcelNumber,PhotosChangeTimestamp,PhotosCount,PostalCode,PostalCodePlus4,PriceChangeTimestamp,PrivateRemarks,PropertySubType,PropertyType,PublicRemarks,StateOrProvince,StatusChangeTimestamp,StoriesTotal,StreetDirPrefix,StreetDirSuffix,StreetName,StreetNumber,StreetSuffix,TaxYear,UnitNumber,YearBuilt,CurrentPrice,RoomCount,UnitCount,SpecialListingConditions,AdditionalApplicantFee,AdditionalLeaseRestrictions,AdditionalMembershipAvailableYN,AdditionalParcelsDescription,AdditionalParcelsYN,AdditionalPetFees,AdditionalWaterInformation,AlternateKeyFolioNum,AmenitiesAdditionalFees,AnnualExpenses,AnnualNetIncome,AnnualRent,AccessibilityFeatures,AdditionalRooms,Appliances,ApplicationFee,ApprovalProcess,AssociationApplicationFee,AssociationApprovalFee,AssociationApprovalRequiredYN,AssociationFee,AssociationFeeRequirement,AttachedGarageYN,AuctionFirmURL,AuctionPropAccessYN,AuctionType,AvailabilityDate,AvailableForLeaseYN,AssociationAmenities,AssociationFeeFrequency,AssociationFeeIncludes,BuilderModel,BuilderName,BuildingElevatorYN,BuildingNameNumber,BuyersPremium,CarportSpaces,CarportYN,CDDYN,CeilingHeight,CeilingType,ClassofSpace,CommunityFeatures,ComplexCommunityNameNCCB,ComplexDevelopmentName,ComTransactionTerms,ComTransactionType,ConditionExpDate,CondoEnvironmentYN,CondoFees,CondoFeesTerm,CondoLandIncludedYN,ConstructionMaterials,ConvertedResidenceYN,Country,CountyLandUseCode,CountyPropertyUseCode,CurrencyMonthlyRentAmt,ContractStatus,DaysNoticeToTenantIfNotRenew,DaysToClosed,DirectionFaces,DisasterMitigation,Disclosures,DoorHeight,DoorWidth,DPRURL,DPRURL2,DPRYN,Easements,ElementarySchool,EndDateofLease,EstAnnualMarketIncome,ExistLseTenantYN,ExpectedClosingDate,FinancingTerms,FireplaceFeatures,FireplaceYN,FlexSpaceSqFt,FloodZoneCode,FloodZoneDate,FloodZonePanel,FloorNumber,ForLeaseYN,FoundationDetails,FreezerSpaceYN,FrontFootage,Furnished,ExteriorFeatures,Fencing,FutureLandUse,GarageDimensions,GarageDoorHeight,GarageSpaces,GarageYN,GrossIncome,GrossScheduledIncome,HERSIndex,HighSchool,HomesteadYN,LandLeaseAmount,LastDateAvailable,LastMonthsRent,LaundryFeatures,LeasableArea,LeaseFee,LeasePrice,Zoning,ZoningCompatibleYN,YrsOfOwnerPriorToLeasingReqYN,LeasePricePerAcre,LeaseTerm,ListAgentFax,ListAgentOfficePhoneExt,ListAgentPager,ListAgentURL,ListOfficeFax,ListOfficeURL,ListTeamName,LongTermYN,LotSizeAcres,LotSizeDimensions,LotSizeSquareFeet,MaxPetWeight,MiddleOrJuniorSchool,MillageRate,MinimumLease,MonthlyCondoFeeAmount,MonthlyHOAAmount,MonthsAvailable,MonthToMonthOrWeeklyYN,MontlyMaintAmtAdditionToHOA,NetOperatingIncome,NewConstructionYN,NumberOfLots,NumberOfPets,NumberOfUnitsTotal,NumofBays,NumofBaysDockHigh,NumofBaysGradeLevel,NumofConferenceMeetingRooms,NumofHotelMotelRms,NumofOffices,NumofRestrooms,NumTimesperYear,AdjoiningProperty,ArchitecturalStyle,BusinessType,CurrentAdjacentUse,Electric,OfficeRetailSpaceSqFt,OffSeasonRent,OriginatingSystemTimestamp,OtherEquipment,OtherExemptionsYN,OtherFeesAmount,OtherFeesDescription,OtherFeesTerm,OtherStructures,OwnerPays,ParkingFeatures,PetDepositFee,PetFeeNonRefundable,PetRestrictions,PetSize,PlannedUnitDevelopmentYN,PoolFeatures,PoolPrivateYN,PricePerAcre,ProjectedCompletionDate,PropertyDescription,PublicSurveyRange,PublicSurveySection,RealtorInfo,RoadFrontageFt,RoadFrontageType,Roof,SeasonalRent,SecurityDeposit,SecurityFeatures,SeniorCommunityYN,ShowingRequirements,SoldRemarks,SpaceType,SpaFeatures,StateLandUseCode,StatePropertyUseCode,SubdivisionName,SubdivisionNum,SubdivisionSectionNumber,SWSubdivCommunityName,SWSubdivCondoNum,City,TaxAnnualAmount,TaxBlock,TaxBookNumber,TaxLegalDescription,TaxLot,TaxOtherAnnualAssessmentAmount,TempOffMarketDate,TenantPays,TotalAcreage,TotalActualRent,TotalMonthlyExpenses,TotalNumBuildings,Township,TransactionBrokerCompensation,TransportationAccess,UnparsedAddress,UseCode,Utilities,Vegetation,View,VirtualTourURLBranded,VirtualTourURLBranded2,VirtualTourURLUnbranded,VirtualTourURLUnbranded2,WarehouseSpaceHeated,WarehouseSpaceTotal,WaterAccess,WaterAccessYN,WaterBodyName,WaterExtras,WaterExtrasYN,WaterFrontageFeetBayHarbor,WaterFrontageFeetBayou,WaterFrontageFeetBeachPrvt,WaterFrontageFeetBeachPub,WaterFrontageFeetBrackishWater,WaterFrontageFeetCanalBrackish,WaterFrontageFeetCanalFresh,WaterFrontageFeetCanalSalt,WaterFrontageFeetCreek,WaterFrontageFeetFCWLSC,WaterFrontageFeetGulfOcean,WaterFrontageFeetICW,WaterFrontageFeetLagoon,WaterFrontageFeetLake,WaterFrontageFeetLakeChain,WaterFrontageFeetMarina,WaterFrontageFeetOcean2Bay,WaterFrontageFeetPond,WaterFrontageFeetRiver,WaterfrontFeetTotal,WaterfrontYN,WaterSource,WaterViewYN,WeeklyRent,WindowFeatures,MLSAreaMajor,AssociationYN,GreenBuildingVerificationType,GreenEnergyEfficient,GreenEnergyGeneration,GreenIndoorAirQuality,GreenLandscaping,GreenWaterConservation,InteriorFeatures,LeaseAmountFrequency,ListingTerms,LotFeatures,Management,MasterBedSize,NumOfOwnYearsPriorToLse,PatioAndPorchFeatures,SpaYN,WeeksAvailable,Flooring,Sewer,PetsAllowed,AnnualIncomeType,WaterView,WaterfrontFeatures,Model,BodyType,CurrentUse,FinancialDataSource,Levels,ListOfficeHeadOfficeKeyNumeric,NonRepCompensation,PropertyCondition,PermitNumber,AssociationEmail,AssociationURL,TotalAnnualFees,BuildingFeatures,BusinessName,YearEstablished,BarnFeatures,FarmType,HorseAmenities,NumberOfPaddocksPastures,NumberOfSeptics,NumberOfStalls,NumberOfWells,SaleIncludes,OccupantType,RoadSurfaceType,OnMarketDate", ",");
...
DELETE FROM `#request.zos.zcoreDatasource#`.`listing_memory` WHERE listing_id LIKE '25-%'; 
		...
		*/
		...
		for(i=1;i LTE arraylen(request.zos.listing.mlsStruct[this.mls_id].sharedStruct.lookupStruct.arrColumns);i++){
			if(not structkeyexists(request.zos.listing.mlsStruct[this.mls_id].sharedStruct.metaStruct["property"].tableFields, removechars(request.zos.listing.mlsStruct[this.mls_id].sharedStruct.lookupStruct.arrColumns[i],1,7))){
				continue;
			}
    ...
    <cffunction name="getDetails" localmode="modern" output="yes" returntype="any">
		...
		if(arguments.ss.listing_photocount EQ 0){
			...
			for(i=1;i LTE arguments.ss.listing_photocount;i++){
				...
				local.absPath='#request.zos.sharedPath#mls-images/25/'&left(local.fNameTempMd51,2)&"/"&mid(local.fNameTempMd51,3,1)&"/"&replace(local.fNameTemp1, ".jpeg", "-large.jpeg");
				if(fileexists(local.absPath)){
					if(i EQ 1){
						request.lastPhotoId=arguments.ss.listing_id;
					}
					idx["photo"&i]=request.zos.retsPhotoPath&'25/'&left(local.fNameTempMd51,2)&"/"&mid(local.fNameTempMd51,3,1)&"/"&replace(local.fNameTemp1, ".jpeg", "-large.jpeg");
				}else{
