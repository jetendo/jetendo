...
<cfoutput>
	...
	if(request.zos.istestserver){
		variables.hqPhotoPath="#request.zos.sharedPath#mls-images/30/";
	}else{
		variables.hqPhotoPath="#request.zos.sharedPath#mls-images/30/";
	}
