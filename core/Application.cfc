...
<cfcomponent displayname="Application" output="no" hint="Handle the application."><cfif (cgi.http_host EQ "jet.zsite.info" or cgi.http_host EQ "jet.local.zsite.info" or cgi.http_host EQ "jet.test.zsite.info")><cfif cgi.http_host EQ "jet.zsite.info"><cfinclude template="/jet_zsite_info/core/config.cfm"><cfelse><cfinclude template="/jet/core/config.cfm"></cfif><cfreturn></cfif><cfif (cgi.http_host CONTAINS "peak.zsite.info" or cgi.http_host CONTAINS "peakidx.com" or cgi.http_host CONTAINS "peak.local.zsite.info" or cgi.http_host CONTAINS "peak.test.zsite.info")><cfif cgi.http_host CONTAINS "peak.zsite.info"><cfinclude template="/peak_zsite_info/config.cfm"><cfelse><cfinclude template="/peak/config.cfm"></cfif><cfreturn></cfif><cfscript>
